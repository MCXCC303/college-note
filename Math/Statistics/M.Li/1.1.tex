...
\end{eg}
\begin{eg}
    有N个乒乓球中有M个白球、N-M个白球，任取$n(n<N)$个球，分有放回和不放回，求取到m个黄球的概率
...
\begin{eg}
    麦克斯韦-玻尔兹曼统计问题：
    n个质点随机落入$N\left( N>n \right) $ 个盒子，盒子容量不限，设$A$ 表示指定的n个盒子各有一个质点，$B$ 表示恰好有n个盒子装一个质点
...
\end{notation}
\begin{eg}
    地面铺满2dm的地砖，向地面投掷一个r=0.5dm的光盘，求光盘不与边线相交的概率
\end{eg}
如图:
\begin{center}
    \begin{tikzpicture}
