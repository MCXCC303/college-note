...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[yscale=0.05,xscale=0.05]
        ...
        \node [] (A) at(40,40) {$A$};
        \draw [domain=0:45] plot (\x,{\x+15});
        \draw [domain=15:60] plot (\x,{\x-15});
    \end{tikzpicture}
\end{figure}
...
\begin{eg}
    ...
    \begin{figure}[htbp]
        ...
        \begin{tikzpicture}[yscale=1.3]
            ...
            \draw [->] (0,0)--(0,3*pi/2) node [above] {$\varphi$};
            \node [anchor=north east] at(0,0) {$O$};

            \draw [] (0,pi)--(4,pi)--(4,0);
            \node [] (Omega) at (2,pi/2) {$\Omega$}; 
            \node [below] (fracd2) at(4,0) {$\frac{d}{2}$};
            \node [left] (pi) at(0,pi) {$\pi$};
        \end{tikzpicture}
    \end{figure}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \node [] (B) at (-3.25,2.3) {$B$};
            \node [] (C) at (-1.5,1.6) {$C$};
            \node [] (displaystylefracl2) at (-4.5,0) {${\frac{l}{2}}$};
    ...
    \begin{figure}[htbp]
        ...
        \begin{tikzpicture}[yscale=1.5]
            ...
            \draw [->] (0,0)--(3*pi/2,0) node [right] {$\varphi$};
            \node [anchor=north east] at(0,0) {$O$};

            \draw [fill=blue,opacity=0.5,domain=0:pi] plot (\x,{1.3*sin(\x r)});
            \draw [domain=0:pi] plot (\x,{1.3*sin(\x r)});
            \draw [] (pi,0)--(pi,2)--(0,2);
            \node [] (Omega) at (3*pi/4,1.7) {$\Omega$}; 
            \node [left] (fracd2) at(0,2) {$\frac{d}{2}$};
            \node [below] (pi) at(pi,0) {$\pi$};
            \draw [dashed] (pi/2,1.3)--(0,1.3);
            \node [] (A) at (pi/2,0.8) {$A$};
            \node [left] (fracl2) at (0,1.5) {$\frac{l}{2}$};
        \end{tikzpicture}
    \end{figure}
